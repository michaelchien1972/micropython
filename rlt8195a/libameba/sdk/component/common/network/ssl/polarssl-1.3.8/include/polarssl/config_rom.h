...
#undef POLARSSL_ECP_C
#undef POLARSSL_ECDH_C
#undef POLARSSL_ECDSA_C
#undef POLARSSL_KEY_EXCHANGE_ECDH_ECDSA_ENABLED
#undef POLARSSL_KEY_EXCHANGE_ECDH_RSA_ENABLED
#undef POLARSSL_KEY_EXCHANGE_ECDHE_PSK_ENABLED
#undef POLARSSL_KEY_EXCHANGE_ECDHE_RSA_ENABLED
#undef POLARSSL_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED
